...
<motion.div initial="hidden" whileInView="visible" variants={stagger} className="flex flex-col md:flex-row gap-6">
{STEPS.map((s, i) => (
<motion.div key={s} variants={fadeInUp} className="glass p-4 rounded-lg flex-1">
